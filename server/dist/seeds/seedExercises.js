...
async function main() {
    ...
    const res = await Exercise_1.default.bulkWrite(ops, { ordered: false });
    console.log(`Seed complete. inserted=${res.upsertedCount || 0}, matched=${res.matchedCount || 0}, modified=${res.modifiedCount || 0}`);
